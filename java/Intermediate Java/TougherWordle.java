...
public class TougherWordle {
    public static void main(String[] args) {
       ...
       */
        ...
        // THIS time, you HAVE the full code. However, printAllGuesses is incomplete,
        // and you must manually finish it all yourself!
