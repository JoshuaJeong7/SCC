...
public class Pokemon {
     ...
     * reference for how you should code your other Pokemons in this program!
    ...
    public void getHit(int hpLost) {
        //Notice that defense is being subtracted from the max health!
        //(This is why you will get catastrophic (really bad) results from making defense GREATER than the max health.)
